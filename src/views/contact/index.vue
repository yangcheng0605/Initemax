<template>
  <div class="contact">
    <div class="top_banner">
      ...
      <div class="t_box">
        <p class="title SmileFont">SUPPORT</p>
      </div>
    </div>
    <div class="a_content a_content2">
      <div class="a_content_top">
        <p class="title SmileFont wow animate__fadeInLeft">联系我们</p>
        <p class="sub_title wow animate__fadeInRight">联系我们</p>
      </div>
      <a-row :gutter="30">
        <a-col class="gutter-row" :xs="24" :sm="24" :md="8">
          <div class="gutter-box hoverBox wow animate__bounceIn" data-wow-offset="50" @click="contact(1)">
            ...
            <div class="a_text">
              ...
              <p class="a_email smallArrow_box">
                <span>WhatsApp: {{ whatsApp }}</span>
                <!-- <img class="smallArrow" src="../../assets/img/about/arrow_r.png" alt="" /> -->
              </p>
            </div>
          </div>
        </a-col>
